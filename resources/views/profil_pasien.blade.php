                ...
                <div class="card-body">
                    <form method="post" action="/Profil/pasien">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="nama" class="form-control" id="inputUsername" type="text" placeholder="Masukkan username" style="width: 42.5rem;" @if($post[0]->pasien)
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="namaAwal" class="form-control" id="inputFirstName" type="text" placeholder="Masukkan nama awal Anda" @if($post[0]->pasien)
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="namaAkhir" class="form-control" id="inputLastName" type="text" placeholder="Masukkan nama akhir Anda" style="width: 20.7rem;" @if($post[0]->pasien)
                        ...
                        <div class="col-md-6">
                                <label class="small mb-1" for="inputstatuspelayanan">Status Pelayanan</label>
                                <input name="statusPelayanan" class="form-control" id="inputstatuspelayanan" type="text" placeholder="Masukkan status pelayanan" style="width: 42.5rem;" @if($post[0]->pasien)
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="lokasi" class="form-control" id="inputLocation" type="text" placeholder="Masukkan lokasi Anda" style="width: 42.5rem;" @if($post[0]->pasien)
                        ...
                        <div class="mb-3">
                            ...
                            <input name="email" class="form-control" id="inputEmailAddress" type="email" placeholder="Masukkan email Anda" @if($post[0]->pasien)
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="noHP" class="form-control" id="inputPhone" type="tel" placeholder="Masukkan nomor hp" @if($post[0]->pasien)
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="tglLahir" class="form-control" id="inputBirthday" type="date" name="birthday" placeholder="Masukkan tanggal lahir Anda" @if($post[0]->pasien)
