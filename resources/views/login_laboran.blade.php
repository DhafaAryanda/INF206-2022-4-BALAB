...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/styles/login-laboran.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('assets/styles/styles.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('assets/bootstrap/list-Materi-Bootstrap/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('assets/styles/laboran.css') }}">
</head>

<body>
    <section class="login-laboran">
        <nav></nav>
        <div class="container">
