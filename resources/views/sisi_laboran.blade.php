            ...
            <div class="container rounded-3" style="height: 1px; width: 900px; background-color: rgba(231, 223, 223, 0.603) margin-left 20px">
              <div class="row fw-bold">
                ...
                <div class="col">
                  <p></p>
                  <br />
                  <div class="bg-light text-center rounded-end" style="width: 10rem; font-family: serif">Dilan</div>
                  <br />
                  <div class="bg-light text-center fw-bold rounded" style="width: 10rem; font-family: serif">2008107010026798</div>
                </div>
                <div class="col">
                  <p></p>
                  <br />
                ...
                <div class="col">
                  <p></p>
                  <br />
                  <div class="bg-light text-center fw-bold rounded fs-8" style="width: 12rem; font-family: serif">dr. Irawan</div>
                  <br />
                  <div class="bg-light tex text-center fw-bold rounded fs-8" style="width: 12rem; font-family: serif">Slamet, S.Tr.Kes.</div>
                </div>
              </div>
            </div>
          </div>
